      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-blue-100 rounded-3xl p-7 shadow-xl shadow-blue-100/60 au1">
          ...
          <div className="space-y-4">
            ...
            <div className="au3">
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} placeholder="กรอกรหัสผ่าน"
                  value={form.password}
          ...
          <button onClick={onSubmit} disabled={loading}
            ...
            {loading
              ? <><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full" style={{animation:'rot .7s linear infinite'}}/>กำลังเข้าสู่ระบบ...</>
        ...
        <p className="text-center text-sm text-slate-500 mt-5">
          ยังไม่มีบัญชี?{' '}
          <Link to="/register" className="text-blue-700 font-bold hover:underline">สมัครสมาชิก</Link>
        </p>
      </div>
    </div>
  )
