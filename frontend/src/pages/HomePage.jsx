...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    desc: 'ในกรณีที่ไม่สามารถเข้าใช้งานห้องตามเวลาที่จองไว้ ขอความกรุณาดำเนินการยกเลิกการจองล่วงหน้า เพื่อให้ผู้อื่นสามารถใช้บริการต่อได้ ขอบคุณค่ะ/ครับ',
  },
  {
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3 mb-4 flex items-start gap-2">
              ...
              <p className="text-xs text-yellow-800">
                {showCheckIn
                  ...
                  : `อีก ${until} ในกรณีที่ไม่สามารถเข้าใช้งานห้องตามเวลาที่จองไว้ ขอความกรุณาดำเนินการยกเลิกการจองล่วงหน้า เพื่อให้ผู้อื่นสามารถใช้บริการต่อได้ ขอบคุณค่ะ/ครับ`}
              </p>
            </div>
          )}
